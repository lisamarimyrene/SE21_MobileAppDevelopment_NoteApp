...
import handleImageSelection from '../utils/handleImageSelection';
import { handleSave, handleCancel } from '../utils/handleSaveCancel';
    ...
    return (
        <View style={styles.newNoteContainer}>
            <View style={styles.saveSection}>
                <TouchableOpacity onPress={() => handleCancel(title, content, handleCancelNote)}>
